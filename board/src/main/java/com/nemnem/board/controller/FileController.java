...
import com.nemnem.board.service.FileService;
...
public class FileController {
    ...
    @ApiOperation(value="파일 업로드", notes="Request Body에 100MB 이하의 file을 포함하여 요청을 하면, 성공 시 다운로드 URL을 반환, 실패 시 null 반환")
    @PostMapping(UPLOAD)
    public String upload(
        @ApiParam(value="업로드 할 파일", required=true)
    ...
    @ApiOperation(value="파일 다운로드", notes="Path Variable에 fileName을 포함하여 요청하면, 성공 시 해당하는 파일의 Resource를 반환, 실패 시 null 반환")
